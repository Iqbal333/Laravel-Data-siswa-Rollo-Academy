              ...
              <div class="panel-heading">
                ...
                <div class="right">
                   <!-- Button trigger modal -->
                    <button class="btn" data-toggle="modal" data-target="#exampleModal" type="button"><i class="lnr lnr-plus-circle"></i></button>
                </div>
              </div>
        ...
        <div class="modal-body">
          <form action="/siswa/create" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{$errors->has('email') ? 'has-error' : ''}}">
              ...
              <input type="email" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" class="form-control" placeholder="Email" value="{{old('email')}}" >
              @if($errors->has('email'))
            ...
            <div class="form-group {{$errors->has('agama') ? 'has-error' : ''}}">
              <label>Agama</label>
              <input name="agama" type="text" placeholder="Agama" class="form-control" value="{{old('agama')}}" >
              @if($errors->has('agama'))
